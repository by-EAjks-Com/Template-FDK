...
add_files -fileset [get_filesets sim_1] -norecurse [file join $work_directory device_under_test.gen sources_1 bd system hdl system_wrapper.vhd]
add_files -fileset [get_filesets sim_1] -norecurse [file join $project_source_dir tests testbench_pkg.vhd]
add_files -fileset [get_filesets sim_1] -norecurse [file join $project_source_dir tests testbench.vhd]
add_files -fileset [get_filesets sim_1] -norecurse [file join $project_source_dir tests testcases_pkg.vhd]
add_files -fileset [get_filesets sim_1] -norecurse [file join $project_source_dir tests testcases.vhd]

set_property \
    -dict [list \
        top testcases \
        generic [list \
            g_testbench_root=[file root [file join $project_source_dir tests files testbench .]] \
            g_testcase_0_root=[file root [file join $project_source_dir tests files testcase_0 .]] \
            g_run_all_testcases=true \
